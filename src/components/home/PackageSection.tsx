                      ...
                      <div className="flex justify-between items-center w-full mt-4">
                        ...
                        <Link
                          href={`/hotels/${item.title
                            .toLowerCase()
                            .replace(/\s+/g, "-")}`}
                          className="bg-transparent border-2 border-secondary text-secondary font-semibold px-6 py-2 lg:px-3 3xl:px-6  rounded-full hover:bg-accent transition-colors text-sm lg:text-[12px] flex items-center gap-2 h-fit"
                        >
                         Detail
